...
public abstract class KloudlessBaseTest {
	...
	private static volatile Folder rootFolder = null;
	...
	protected synchronized String getRootFolderId(String testAccount) throws
	...
	protected int deleteTestFile(final String id, final String testAccount,
			final boolean permanent) throws APIException, AuthenticationException,
	...
	protected int deleteTestFolder(final String id, final String testAccount,
			final boolean recusive, final boolean permanent) throws APIException,
	...
	protected Folder createTestFolder(final String folderName, final String parentId,
			final String testAccount) throws APIException, AuthenticationException,
			InvalidRequestException, APIConnectionException {
		Map<String, Object> params = new HashMap<>();
		System.out.println("creating a folder called \"" + folderName + "\"");
		params.put("name", folderName);
		params.put("parent_id", parentId);
		Folder createdFolder = Folder.create(testAccount, params);
		return createdFolder;
	}
	
	
	protected File createTestFile(final String fileName, final java.io.File file,
			final String parentId, final String testAccount) throws APIException,
			AuthenticationException, InvalidRequestException, APIConnectionException,
			IOException {
